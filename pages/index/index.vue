<template>
	<view class="content">
		<view class="top-bar">
			<view class="top-bar-left"><image src="../../static/images/avatar.jpg" mode=""></image></view>
			<view class="top-bar-center"><image src="../../static/images/logo.png" mode=""></image></view>
		...
		<view class="apply">
			<view class="avatar">
				<view class=" iconfont icon-tianjiahaoyou"><text class="tip">1</text></view>
			</view>
			<view class="message">
				...
				<view class="message-bottom">请求添加好友</view>
			</view>
		</view>
		<view class="apply" v-for="friend in friendList" :key="friend.id" @click="goMessagePage(friend.id)">
			<view class="avatar">
			...
			<view class="message">
				...
				<view class="message-bottom">what are you doingwhat are you doingwhat are you doingwhat are you doing</view>
			</view>
		</view>
