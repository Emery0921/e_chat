<template>
	<view>
		<view class="top-bar">
			<view class="top-bar-right"><text @click="register">注册</text></view>
		</view>
		<view class="logo"><image src="../../static/images/火.png" alt=""></image></view>
		<view class="main">
			<view class="title">登录</view>
			<view class="sub-title">您好，欢迎来到e_chat!</view>
			<view class="login">
			...
			<view class="forget-password" @click="goForPassPage">忘记密码</view>
			<view class="btn-login"><button @click="submit">登录</button></view>
